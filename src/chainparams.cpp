...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("kore.life", "dnsseed2.kore.life"));
        vSeeds.push_back(CDNSSeedData("kore.life", "dnsseed3.kore.life"));
        vSeeds.push_back(CDNSSeedData("kore.life", "dnsseed4.kore.life"));
